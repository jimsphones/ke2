...
var str = currentURL;
var res = str.replace("https://shortgetlinku.blogspot.com/2021/08/get.html?url=", "");
...
j++;}
if(a_to_vh==false)
{var encryptedUrl=Base64.encode(a_to_vi);a_to_ve[i].href="https://shortgetlinku.blogspot.com/2021/08/get.html?url="+ encryptedUrl;a_to_ve[i].rel="nofollow";a_to_vb++;a_to_vc+=i+":::"+ a_to_ve[i].href+"\n";}}
